...
from strategy_test import Strategy
...
class Backtesting:
    ...
    def test_hardcoding(self):
        ...
        request_backtesting = {
            "input_parameters": {
                "strategy": "SimpleMovingAverageCross",    # SimpleMovingAverageCross, MovingAverageCross, RSI
                "currency_pair_groups": "JPY_Group",
                "SL": 0.01,
                "TP": 0.02,
                "EMA_periods": [200, 50, 20],
                # "indicator_inputs": {             # RSI
                #     "RSI_period": 14, 
                #     "RSI_overbought": 70,
                #     "RSI_oversold": 30,
                # },
                "indicator_inputs": {"SMA_periods": [5, 20]}, # SimpleMovingAverageCross
                "order_settings_template": "lot_1_20_10"
            },
            # Define instrument and dates
            "instrument": "EUR_USD",
            "start_date": "2020-01-01",
            "end_date": "2020-01-04",
            "timeframe": "H2",  # 1-hour candles
            "trading_hours": [9, 16]
            # Example of 24-hour forex market trading hours, with no filter:
            # trading_hours = None
        }
